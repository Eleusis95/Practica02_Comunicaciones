...
#define PIN21_IDX                       21u   /*!< Pin number for pin 22 in a port */
#define PIN26_IDX                       26u   /*!< Pin number for pin 22 in a port */
...
void BOARD_InitPins(void) {
  ...
  PORT_SetPinMux(PORTB, PIN3_IDX, kPORT_PinDisabledOrAnalog); /* PORTB2 (pin ) is configured as ADC0_SE12 */
  PORT_SetPinMux(PORTC, PIN2_IDX, kPORT_MuxAlt4);            /* PORTC1 (pin 71) is configured as FTM0_CH0 */
  ...
  /*encoder*/
    const port_pin_config_t portb9_pin57_config = {
        kPORT_PullUp,                                            /* Internal pull-up resistor is enabled */
        kPORT_FastSlewRate,                                      /* Fast slew rate is configured */
        kPORT_PassiveFilterDisable,                              /* Passive filter is disabled */
        kPORT_OpenDrainDisable,                                  /* Open drain is disabled */
  ...
  const port_pin_config_t portc10_pin_config = {
         kPORT_PullUp,                                            /* Internal pull-up resistor is enabled */
         kPORT_FastSlewRate,                                      /* Fast slew rate is configured */
         kPORT_PassiveFilterDisable,                              /* Passive filter is disabled */
         kPORT_OpenDrainDisable,                                  /* Open drain is disabled */
  ...
  PORT_SetPinConfig(PORTB, PIN9_IDX, &portb9_pin57_config);         /* PORTB22 (pin 57) is configured as PTB9 */
  PORT_SetPinConfig(PORTC, PIN10_IDX, &portc10_pin_config);         /* PORTB22 (pin 57) is configured as PTB3 */
  PORT_SetPinMux(PORTB, PIN1_IDX, kPORT_MuxAlt4);            /* PORTB1 (pin 54) is configured as RMII0_MDC */
  PORT_SetPinMux(PORTB, PIN16_IDX, kPORT_MuxAlt3);           /* PORTB16 (pin 62) is configured as UART0_RX */
  PORT_SetPinMux(PORTB, PIN17_IDX, kPORT_MuxAlt3);           /* PORTB17 (pin 63) is configured as UART0_TX */
  PORT_SetPinMux(PORTB, PIN21_IDX, kPORT_MuxAsGpio);         /* PORTB22 (pin ) is configured as PTB21 */
  PORT_SetPinMux(PORTB, PIN22_IDX, kPORT_MuxAsGpio);         /* PORTB22 (pin 68) is configured as PTB22 */
  PORT_SetPinMux(PORTE, PIN26_IDX, kPORT_MuxAsGpio);         /* PORTB22 (pin 68) is configured as PTB26 */
  PORT_SetPinMux(PORTC, PIN5_IDX, kPORT_MuxAsGpio);         /* PORTC5 (pin ) is configured as PTB5 */
  PORT_SetPinMux(PORTC, PIN7_IDX, kPORT_MuxAsGpio);         /* PORTC5 (pin ) is configured as PTB7 */
