...
#define BOARD_HALL_GPIO GPIOC
#endif
#ifndef BOARD_HALL_PORT
#define BOARD_HALL_PORT PORTC
#endif
#ifndef BOARD_HALL_GPIO_PIN
#define BOARD_HALL_GPIO_PIN 10U
#endif
#define BOARD_HALL_S_IRQ         PORTC_IRQn
#define BOARD_HALL_IRQ_HANDLER PORTC_IRQHandler
#define BOARD_HALL_NAME        "HALL"
...
/*************input de encoder********************/
#ifndef BOARD_ENCODER_GPIO
#define BOARD_ENCODER_GPIO GPIOB
#endif
#ifndef BOARD_ENCODER_PORT
#define BOARD_ENCODER_PORT PORTB
#endif
#ifndef BOARD_ENCODER_GPIO_PIN
#define BOARD_ENCODER_GPIO_PIN 9U
#endif
#define BOARD_ENCODER_IRQ         PORTB_IRQn
#define BOARD_ENCODER_IRQ_HANDLER PORTB_IRQHandler
#define BOARD_ENCODER_NAME        "ENCODER"
/*************************************************/
/******************HALL**************************/
/************************************************/
...
#endif
/*MOTOR turn LEFT*/
#ifndef BOARD_LEFT_MOTOR_GPIO
#define BOARD_LEFT_MOTOR_GPIO GPIOC
#endif
#define BOARD_LEFT_MOTOR_GPIO_PORT PORTC
#ifndef BOARD_LEFT_MOTOR_GPIO_PIN
#define BOARD_LEFT_MOTOR_GPIO_PIN 5U
#endif
/*MOTOR turn ON*/
#ifndef BOARD_RIGHT_MOTOR_GPIO
#define BOARD_RIGHT_MOTOR_GPIO GPIOC
#endif
#define BOARD_RIGHT_MOTOR_GPIO_PORT PORTC
#ifndef BOARD_RIGHT_MOTOR_GPIO_PIN
#define BOARD_RIGHT_MOTOR_GPIO_PIN 7U
#endif
...
/*MOTOR turn left*/
#define PIN_LEFT_MOTOR_INIT(output)                                           \
    GPIO_PinWrite(BOARD_LEFT_MOTOR_GPIO, BOARD_LEFT_MOTOR_GPIO_PIN, output); \
    BOARD_LEFT_MOTOR_GPIO->PDDR |= (1U << BOARD_LEFT_MOTOR_GPIO_PIN)                        /*!< Enable target PIN_LEFT_MOTOR */
#define PIN_LEFT_MOTOR_ON() GPIO_PortClear(BOARD_LEFT_MOTOR_GPIO, 1U << BOARD_LEFT_MOTOR_GPIO_PIN) /*!< Turn on target PIN_LEFT_MOTOR */
#define PIN_LEFT_MOTOR_OFF() GPIO_PortSet(BOARD_LEFT_MOTOR_GPIO, 1U << BOARD_LEFT_MOTOR_GPIO_PIN)  /*!< Turn off target PIN_LEFT_MOTOR */
#define PIN_LEFT_MOTOR_TOGGLE() \
    GPIO_PortToggle(BOARD_LEFT_MOTOR_GPIO, 1U << BOARD_LEFT_MOTOR_GPIO_PIN) /*!< Toggle on target PIN_LEFT_MOTOR */

/*MOTOR turn right*/
#define PIN_RIGHT_MOTOR_INIT(output)                                           \
    GPIO_PinWrite(BOARD_RIGHT_MOTOR_GPIO, BOARD_RIGHT_MOTOR_GPIO_PIN, output); \
    BOARD_RIGHT_MOTOR_GPIO->PDDR |= (1U << BOARD_RIGHT_MOTOR_GPIO_PIN)                        /*!< Enable target PIN_LEFT_MOTOR */
#define PIN_RIGHT_MOTOR_ON() GPIO_PortClear(BOARD_RIGHT_MOTOR_GPIO, 1U << BOARD_RIGHT_MOTOR_GPIO_PIN) /*!< Turn on target PIN_LEFT_MOTOR */
#define PIN_RIGHT_MOTOR_OFF() GPIO_PortSet(BOARD_RIGHT_MOTOR_GPIO, 1U << BOARD_RIGHT_MOTOR_GPIO_PIN)  /*!< Turn off target PIN_LEFT_MOTOR */
#define PIN_RIGHT_MOTOR_TOGGLE() \
    GPIO_PortToggle(BOARD_RIGHT_MOTOR_GPIO, 1U << BOARD_RIGHT_MOTOR_GPIO_PIN) /*!< Toggle on target PIN_LEFT_MOTOR */
